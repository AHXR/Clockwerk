...
/*
 * TimerControl is used in nearly all the other Java files. This class controls
 ...
 */
public class TimerControlEvents {
	...
	public static void setTimerStatus( boolean b_status ) {
		b_timer_status = b_status;
	}
	
	public static void setBountyRunesToggle( boolean b_status ) {
		b_bountyrunes = b_status;
	}
	
	public static void setCampStacksToggle( boolean b_status ) {
		b_campstacks = b_status;
	}
	
	public static void setWarningSignal( int w, boolean toggle ) {
		switch( w ) {
			case 0: {
				b_onTime = toggle;
				break;
